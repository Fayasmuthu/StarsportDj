...
class AvailableSizeForm(forms.ModelForm):
    class Meta:
        model = AvailableSize
        fields = ('weight', 'unit', 'sale_price', 'discount_price', 'is_stock',)
        widgets = {
            ...
            "discount_price": forms.TextInput(attrs={"placeholder": "Regular Price ","class": "required form-control",'type':'number','required': True}),
